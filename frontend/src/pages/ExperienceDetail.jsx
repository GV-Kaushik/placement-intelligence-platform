...
export default function ExperienceDetail() {
  ...
  if (error || !experience) {
    return (
      <div className="min-h-screen bg-slate-950 text-white flex flex-col items-center justify-center">
        ...
        <Link to="/experiences" className="text-indigo-400 hover:underline flex items-center gap-2">
  ...
  if (experience && experience.rounds && Array.isArray(experience.rounds)) {
    for (let i = 0; i < experience.rounds.length; i++) {
      ...
      roundElements.push(
        <div key={i} className="bg-slate-900/50 border border-slate-800 p-6 rounded-2xl relative pl-12 overflow-hidden">
  ...
  if (experience && experience.questions && Array.isArray(experience.questions)) {
    for (let i = 0; i < experience.questions.length; i++) {
      ...
      questionElements.push(
        <div key={i} className="bg-slate-900 border border-slate-800 p-5 rounded-2xl flex flex-col sm:flex-row gap-4 justify-between items-start">
          <div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 mb-8 relative">
          ...
          <div className="flex flex-col md:flex-row gap-6">
            <div className="h-20 w-20 bg-gradient-to-br from-indigo-500/20 to-purple-500/20 rounded-2xl flex items-center justify-center text-indigo-400 shrink-0">
          ...
          <button 
            ...
            disabled={upvoting}
            className={`absolute -bottom-6 right-8 flex items-center gap-2 px-6 py-3 rounded-full border shadow-xl transition-all ${
